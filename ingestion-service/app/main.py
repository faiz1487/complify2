"""Ingestion service: upload documents to S3 and persist metadata."""
...
def root() -> dict:
    return {
        ...
        "endpoints": {
            ...
            "health": "GET /health",
            "health_via_alb": "GET /health/ingestion",
        },
    }


@app.get("/health/ingestion", tags=["health"])
...
def health_check() -> dict:
    ...
    return {"status": status, "service": "ingestion-service", "checks": checks}
